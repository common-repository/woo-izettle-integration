    ...
    class WC_iZettle_Quick_Bulk_Edit
    {
        ...
        public function quick_edit_fields()
        {
            ?>
                ...
                <div class="barcode_field">
                    <label>
                        <span class="title"><?php esc_html_e('Barcode', 'woo-izettle-integration');?></span>
                        <span class="input-text-wrap">
                            <input type="text" name="_izettle_barcode" class="text izettle_barcode" placeholder="<?php esc_attr_e('Barcode', 'woo-izettle-integration');?>" value="">
                        </span>
                    </label>
                </div>
            <?php
        ...
        public function quick_edit_save($product)
        {
            ...
            // update the barcode
            if (isset($_REQUEST['_izettle_barcode'])) {
                update_post_meta($product_id, '_izettle_barcode', $_REQUEST['_izettle_barcode']);
            }
        ...
        public function generate_data($column, $post_id)
        {
            switch ($column) {
                case 'name':
                    ...
                    <div class="izettle_barcode">' . esc_html(get_post_meta($post_id, '_izettle_barcode', true)) . '</div>
                    </div>
                    ';
                    break;
            }
