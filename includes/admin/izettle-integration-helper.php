...
if (!class_exists('WC_Zettle_Helper', false)) {
    ...
    class WC_Zettle_Helper
    {
        ...
        public static function sanitize_attribute_string($string) {
            // Remove all non-alphanumeric characters except for - and _
        ...
        public static function isWPMLMultiCurrencyEnabled() {
            return (function_exists('wcml_is_multi_currency_on') && wcml_is_multi_currency_on() && class_exists('WCML_Multi_Currency_Prices') && method_exists('WCML_Multi_Currency_Prices', 'get_product_price_in_currency'));
        }
    }
}
